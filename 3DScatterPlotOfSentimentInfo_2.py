...
from sentimentVisualization import plotMatrix3DScatterByMatPlotLib
...
#perform 3D scatter plot of sentiments
plotMatrix3DScatterByMatPlotLib(sentiment_scores)
